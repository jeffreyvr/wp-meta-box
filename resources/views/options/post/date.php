<div class="wmb-input">
    ...
    <div>
        <input name="<?php echo esc_attr($option->get_name_attribute()); ?>" id="<?php echo $option->get_id_attribute(); ?>" type="date" style="" value="<?php echo $option->get_value_attribute(); ?>" class="">
