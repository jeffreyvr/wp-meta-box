<div class="wmb-input wbm-repeater">
    ...
    <?php //ray($option->group_options()); ?>

    <div>
        <div class="wbm-repeater-container" wbm-repeater-name="<?php echo $option->get_name(); ?>">
            <?php foreach($option->get_options() as $group_options) { ?>
                <div class="wbm-repeater-option-group">
                    <div class="wbm-repeater-option-group-header">
                        <svg class="wbm-drag" width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" role="img" aria-hidden="true" focusable="false"><path d="M5 4h2V2H5v2zm6-2v2h2V2h-2zm-6 8h2V8H5v2zm6 0h2V8h-2v2zm-6 6h2v-2H5v2zm6 0h2v-2h-2v2z"></path></svg>

                        <button type="button" class="wbm-delete">
        ...
        <button type="button" class="wbm-repeat components-button is-secondary is-small">+ Add Row</button>
    </div>
</div>
